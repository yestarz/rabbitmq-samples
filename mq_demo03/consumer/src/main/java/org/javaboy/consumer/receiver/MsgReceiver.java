...
public class MsgReceiver {
    ...
    public void handleMsg(Message message, Channel channel) throws IOException {
        ...
        //确认消息，就是告诉 RabbitMQ，这条消息我已经消费成功了.第二个参数为是否批量处理
...
//        System.out.println("msg = " + msg);
    ...
    public void handleMsg2(Message message,Channel channel) throws IOException {
        //System.out.println("msg2 = " + message.getPayload() + "---" + Thread.currentThread().getName());
        //拒绝消费该消息，第二个参数requeue 表示被拒绝的消息是否重新进入队列中
